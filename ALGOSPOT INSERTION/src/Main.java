...
/**
 * INSERTION 삽입 정렬 뒤집기 / ALGOSPOT
 * 문제링크 : https://algospot.com/judge/problem/read/INSERTION
 * 답안 제출하면, 시간 초과 - -;
 * ArrayList로 했을 때, 시간초과는 이해하겠는대,
 * HashSet으로 코딩했는대도, 시간초과는... 시간을 좀 더 줘야 하는 거 아닌가?
 */
public class Main {
    int N;
    int[] dt;
