...
/**
 * JOSEPHUS 조세푸스 문제 / ALGOSPOT
 * 문제링크 : https://algospot.com/judge/problem/read/JOSEPHUS
 * 제출링크 : https://algospot.com/judge/submission/detail/658237
 */
public class Main {
    int N;
    int K;
    ...
    public void JOSEPHUS(int n, int k) throws IOException {
