...
/**
 * BRACKETS2 Mismatched Brackets / ALGOSPOT
 * 문제링크 : https://algospot.com/judge/problem/read/BRACKETS2
 * 제출링크 : https://algospot.com/judge/submission/detail/658262
 */
public class Main {
    int N;
    int[][] dp;
    ...
    public void solve() throws IOException {
        ...
        for(int t=0; t<T; ++t) {
            ...
            String r = BRACKETS2(S);
            println(r);
        }
    }

    public String BRACKETS2(String S) {
        boolean br = true;
        ...
        return (br == true)? "YES": "NO";
    }

    boolean IsMatched(ArrayList<Character> al, char cExpected) {
        if(al.size() <= 0) {
            return false;
        }
