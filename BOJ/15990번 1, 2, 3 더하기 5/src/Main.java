 ...
 * 제출링크 : https://www.acmicpc.net/source/20025230
 * 문제풀이 : https://skysign.tistory.com/244
 */
public class Main {
    int N;
    long[][] dp;
    ...
    public void solve() throws IOException {
        ...
        for(int i=2; i<=max; ++i) {
            ...
            dp[i][1] %= _1_000_000_009;
            dp[i][2] %= _1_000_000_009;
            dp[i][3] %= _1_000_000_009;
        }

        for(int i=0; i<N; ++i) {
            long l = dp[dt[i]][1] + dp[dt[i]][2] + dp[dt[i]][3];
            println(l % _1_000_000_009);
        }
    }
